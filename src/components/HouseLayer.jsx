...
// timeOfDay and weather condition. Stable IDs on every element for
// future animation (#door, #garage-door, #crape-myrtle, ...).
// =============================================================
...
<defs>
    ...
    <pattern id="scallop" width="22" height="14" patternUnits="userSpaceOnUse">
      <circle cx="11" cy="1" r="9.5" fill="#FFFFFF"/>
    </pattern>
    ...
    <g id="winShuttered">
      <rect x="-14" y="-6" width="28" height="92" rx="6" fill="#FFFFFF" stroke="#5B6FA0" strokeWidth="3"/>
  ...
  {/* ============ BACKDROP TREES ============ */}
  <g id="trees-back" stroke="#5E8556" strokeWidth="4">
    <ellipse cx="120" cy="360" rx="120" ry="150" fill="#8FB57E"/>
    <ellipse cx="55" cy="250" rx="80" ry="110" fill="#7EA86E"/>
    <ellipse cx="1140" cy="380" rx="105" ry="135" fill="#8FB57E"/>
  </g>
  ...
  <g id="house" strokeLinejoin="round">
    ...
    <g id="chimney">
      <rect x="552" y="152" width="38" height="110" fill="#A9BEE6" stroke="#5B6FA0" strokeWidth="4"/>
      <rect x="545" y="138" width="52" height="18" rx="5" fill="#FFFFFF" stroke="#5B6FA0" strokeWidth="4"/>
    </g>

    {/* ===== LEFT WING (two-story, porch) ===== */}
    <g id="wing-left">
      <polygon points="170,366 295,232 420,366" fill="#93AEDC" stroke="#5B6FA0" strokeWidth="4"/>
      <rect x="170" y="362" width="250" height="278" fill="#93AEDC" stroke="#5B6FA0" strokeWidth="4"/>
      <g id="siding-left" stroke="#7E9BCF" strokeWidth="2.5">
        <path d="M176,420 h238 M176,450 h238 M176,480 h238 M176,540 h238"/>
      </g>
      <rect id="scallop-band-left" x="176" y="372" width="238" height="8" fill="#FFFFFF"/>
      <rect x="176" y="380" width="238" height="13" fill="url(#scallop)"/>
      <g id="vent-left">
        <polygon points="295,272 308,277 313,290 308,303 295,308 282,303 277,290 282,277" fill="#FFFFFF" stroke="#5B6FA0" strokeWidth="3"/>
      ...
      <g id="window-left-upper">
        ...
        <rect x="258" y="408" width="74" height="96" rx="7" fill="none" stroke="#5B6FA0" strokeWidth="3"/>
        <path d="M295,408 v96 M258,456 h74" stroke="#FFFFFF" strokeWidth="5"/>
      </g>
      <g id="porch-rail" stroke="#5B6FA0" strokeWidth="3">
        ...
        <rect x="176" y="580" width="240" height="11" rx="5" fill="#FFFFFF"/>
        <rect x="176" y="628" width="240" height="10" rx="5" fill="#FFFFFF"/>
      </g>
    </g>

    {/* ===== CENTER ENTRY GABLE ===== */}
    <g id="gable-center">
      <polygon points="425,350 522,184 620,350" fill="#93AEDC" stroke="#5B6FA0" strokeWidth="4"/>
      <rect x="425" y="346" width="195" height="294" fill="#93AEDC" stroke="#5B6FA0" strokeWidth="4"/>
      <g id="siding-center" stroke="#7E9BCF" strokeWidth="2.5">
        <path d="M431,400 h183 M431,430 h183 M431,490 h183 M431,520 h183"/>
      </g>
      <rect id="scallop-band-center" x="431" y="356" width="183" height="8" fill="#FFFFFF"/>
      <rect x="431" y="364" width="183" height="13" fill="url(#scallop)"/>
      <g id="vent-center">
        <polygon points="522,228 534,233 539,245 534,257 522,262 510,257 505,245 510,233" fill="#FFFFFF" stroke="#5B6FA0" strokeWidth="3"/>
      ...
      <g id="window-center-upper">
        ...
        <rect x="490" y="388" width="64" height="92" rx="7" fill="none" stroke="#5B6FA0" strokeWidth="3"/>
      ...
      <g id="door">
        ...
        <rect x="470" y="528" width="62" height="110" rx="7" fill="#FFFFFF" stroke="#5B6FA0" strokeWidth="3.5"/>
      ...
      <g id="house-number">
        <rect x="540" y="540" width="40" height="22" rx="5" fill="#FFFFFF" stroke="#5B6FA0" strokeWidth="2.5"/>
        <text x="560" y="557" textAnchor="middle" fontSize="15" fontWeight="bold" fill="#5B6FA0">769</text>
      </g>
      <g id="window-porthole">
        <polygon points="585,576 597,581 602,593 597,605 585,610 573,605 568,593 573,581" fill="#FFFFFF" stroke="#5B6FA0" strokeWidth="3"/>
    ...
    {/* ===== RIGHT WING (garage) ===== */}
    <g id="wing-right">
      <polygon points="620,382 840,216 1060,382" fill="#93AEDC" stroke="#5B6FA0" strokeWidth="4"/>
      <rect x="620" y="378" width="440" height="262" fill="#93AEDC" stroke="#5B6FA0" strokeWidth="4"/>
      <g id="siding-right" stroke="#7E9BCF" strokeWidth="2.5">
        <path d="M626,418 h428 M626,448 h428 M626,478 h428 M626,508 h428"/>
      </g>
      <rect id="scallop-band-right" x="626" y="390" width="428" height="8" fill="#FFFFFF"/>
      <rect x="626" y="398" width="428" height="13" fill="url(#scallop)"/>
      <g id="vent-right">
        <polygon points="840,262 855,268 861,283 855,298 840,304 825,298 819,283 825,268" fill="#FFFFFF" stroke="#5B6FA0" strokeWidth="3"/>
      ...
      <g id="window-right-upper">
        ...
        <rect x="782" y="420" width="116" height="100" rx="8" fill="none" stroke="#5B6FA0" strokeWidth="3"/>
      ...
      <g id="garage-door">
        <rect x="665" y="546" width="350" height="92" rx="10" fill="#FFFFFF" stroke="#5B6FA0" strokeWidth="3.5"/>
      ...
      <g id="lamps">
        <g transform="translate(644,552)">
          <rect x="-8" y="0" width="16" height="22" rx="3" fill="#FFE9A8" stroke="#44506E" strokeWidth="3"/>
          <path d="M-9,0 L0,-9 L9,0 Z" fill="#44506E"/>
        </g>
    ...
    <g id="roofs" fill="none" strokeLinecap="round">
      <path id="roof-left" d="M150,380 L295,228 L440,380" stroke="#A6957F" strokeWidth="28"/>
      <path d="M150,380 L295,228 L440,380" stroke="#BBAB94" strokeWidth="12"/>
      <path id="roof-center" d="M406,362 L522,180 L638,362" stroke="#A6957F" strokeWidth="26"/>
      <path d="M406,362 L522,180 L638,362" stroke="#BBAB94" strokeWidth="11"/>
      <path id="roof-right" d="M598,394 L840,212 L1082,394" stroke="#A6957F" strokeWidth="30"/>
      <path d="M598,394 L840,212 L1082,394" stroke="#BBAB94" strokeWidth="13"/>
    </g>

    {/* ===== PORCH DECK + STEPS ===== */}
    <g id="porch-steps" stroke="#A9854F" strokeWidth="3">
      <rect id="deck" x="168" y="636" width="470" height="16" rx="6" fill="#C9A570"/>
      <rect x="178" y="652" width="240" height="34" fill="url(#lattice)" stroke="#5B6FA0" strokeWidth="3"/>
  ...
  <g id="bush-right">
    <circle cx="1085" cy="600" r="44" fill="#8FB57E" stroke="#5E8556" strokeWidth="3"/>
    <circle cx="1135" cy="618" r="36" fill="#7EA86E" stroke="#5E8556" strokeWidth="3"/>
    <circle cx="1072" cy="582" r="6" fill="#FFFFFF"/><circle cx="1100" cy="600" r="6" fill="#FFFFFF"/>
    <circle cx="1130" cy="606" r="6" fill="#F995BD"/><circle cx="1090" cy="622" r="6" fill="#FFFFFF"/>
  </g>

  {/* ============ SAND ============ */}
  <g id="sand">
    <path d="M-2200,662 Q-2000,644 -1800,658 T-1400,656 T-1000,658 T-600,656 T-200,658 T200,656 T600,660 T1000,658 T1400,660 T1800,656 T2200,658 T2600,656 L3400,656 L3400,2200 L-2200,2200 Z" fill="#F2DFB3"/>
    <path d="M-2200,718 Q-1950,698 -1700,712 T-1200,710 T-700,712 T-200,710 T300,714 T800,710 T1300,712 T1800,710 T2300,712 L3400,710 L3400,2200 L-2200,2200 Z" fill="#EBD3A0"/>
    <g id="driveway">
    ...
    </g>    <g id="sand-speckles" fill="#D9BC85">
    ...
    <g id="beach-grass" fill="none" stroke="#B9C98A" strokeWidth="5" strokeLinecap="round">
    ...
    <g id="pail" transform="translate(386,712)">
      <path d="M-20,-26 L20,-26 L14,14 L-14,14 Z" fill="#F4769B" stroke="#C84279" strokeWidth="3.5" strokeLinejoin="round"/>
      <path d="M-17,-26 a17,12 0 0 1 34,0" fill="none" stroke="#C84279" strokeWidth="3.5"/>
    ...
    <g id="beach-ball" transform="translate(1108,742)">
      <circle r="24" fill="#FFFFFF" stroke="#5B6FA0" strokeWidth="3.5"/>
      <path d="M0,-24 Q-17,0 0,24 Z" fill="#F0649C"/>
      <path d="M0,-24 Q17,0 0,24 Q8,0 0,-24" fill="#5FC3D8"/>
      <circle r="24" fill="none" stroke="#5B6FA0" strokeWidth="3.5"/>
    </g>
  </g>
      </svg>
    </div>
